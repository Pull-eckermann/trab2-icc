...
if __name__ == "__main__":
    ...
    L2padrao_csv = open("../trab2-original/noOPT_L2Padrao.csv", "w")
    L2inexato_csv= open("../trab2-original/noOPT_L2Inexato.csv", "w")
    DPpadrao_csv = open("../trab2-original/noOPT_FLOPS_DPPadrao.csv", "w")
    DPinexato_csv= open("../trab2-original/noOPT_FLOPS_DPInexato.csv", "w")
    AVXpadrao_csv= open("../trab2-original/noOPTPadrao_FLOPS_AVX.csv", "w")
    AVXinexat_csv= open("../trab2-original/noOPTInexat_FLOPS_AVX.csv", "w")
    CLOCKpadrao_csv = open("../trab2-original/noOPT_CLOCKPadrao.csv", "w")
